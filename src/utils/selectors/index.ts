...
export const pipeExpression = `callee.property.name='pipe'`
export const selectOperator = `CallExpression[callee.name='select']`
export const pipeableSelect = `CallExpression[${pipeExpression}] ${selectOperator}`
